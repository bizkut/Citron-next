// SPDX-FileCopyrightText: Copyright 2022 citron Emulator Project
...
enum class SupportTags {
    ...
    AudioOutputDeviceUpdate,
    AudioInputDeviceUpdate,
    HeadphoneOutputLevelMode,
    SystemOutputMasterVolume,
    AudioVolumeDataPlayReport,
    HearingProtectionSafeguard,
    VolumeButtonLongPress,
    AudioDeviceAutoTune,
    OpusHardwareDecoding,
    MultiStreamOpusDecoding,
    LargeFrameOpusDecoding,
    ...
    constexpr std::array<std::pair<SupportTags, u32>, static_cast<u32>(SupportTags::Size)> features{
        {
            ...
            {SupportTags::SplitterPrevVolumeReset, 5},
            ...
            {SupportTags::AudioOutputDeviceUpdate, 3},
            {SupportTags::AudioInputDeviceUpdate, 3},
            {SupportTags::HeadphoneOutputLevelMode, 3},
            {SupportTags::SystemOutputMasterVolume, 4},
            {SupportTags::AudioVolumeDataPlayReport, 4},
            {SupportTags::HearingProtectionSafeguard, 14},
            {SupportTags::VolumeButtonLongPress, 15},
            {SupportTags::AudioDeviceAutoTune, 18},
            {SupportTags::OpusHardwareDecoding, 1},
            {SupportTags::MultiStreamOpusDecoding, 3},
            {SupportTags::LargeFrameOpusDecoding, 12},
            {SupportTags::AudioPerformanceMetrics, 5},
            {SupportTags::AudioDebugFeatures, 1},
        }};
