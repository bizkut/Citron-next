...
enum class AppletProgramId : u64 {
    ...
    Gift = 0x010000000000101Aull,
    DummyShop = 0x010000000000101Bull,
    UserMigration = 0x010000000000101Cull,
    EncounterSys = 0x010000000000101Dull,
    Story = 0x0100000000001020ull,
    PreomiaSys = 0x010000000000101Dull,
    Sample = 0x0100000000001038ull,
